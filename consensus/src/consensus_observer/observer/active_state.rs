...
impl ActiveObserverState {
    pub fn new(
        ...
        ActiveObserverState::new_with_root(node_config, reconfig_events, root)
    }
...
mod test {
    ...
    fn test_check_root_epoch_and_round() {
        ...
        let observer_state =
            ActiveObserverState::new_with_root(NodeConfig::default(), reconfig_events, root);
