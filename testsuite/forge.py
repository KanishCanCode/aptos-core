...
class K8sForgeRunner(ForgeRunner):
    ...
    def run(self, context: ForgeContext) -> ForgeResult:
        ...
        rendered = template.decode().format(
            ...
            FORGE_RETAIN_ALL_LOGS=context.forge_retain_all_logs,
...
@envoption("FORGE_RETAIN_ALL_LOGS", "false")
@envoption("IMAGE_TAG")
...
def test(
    ...
    forge_context = ForgeContext(
        ...
        forge_retain_all_logs=forge_retain_all_logs,
